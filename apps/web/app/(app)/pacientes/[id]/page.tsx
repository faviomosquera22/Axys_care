    ...
    <div className="stack">
      <section className="clinical-hero">
        ...
        <div className="patient-tabbar patient-tabbar--hero">
          <span className="patient-tabbar__summary">Desde aquí decides el siguiente paso clínico.</span>
          <Link
            href={`/historia-clinica?patientId=${patient.id}`}
        ...
        <div className="clinical-layout__main stack">
          <Card className="patient-spotlight">
            <SectionHeading
              ...
              description="La ficha debe priorizar la siguiente decisión clínica, no solo mostrar antecedentes."
            />
          ...
          <Card>
            <SectionHeading
              title="Accesos clave"
              description="Acciones frecuentes sobre el mismo expediente vivo del paciente."
            />
          ...
          <Card>
            <SectionHeading
              ...
              description="Cada encuentro conserva su autor, estado y la mejor siguiente acción."
            />
            {encounters.length ? (
        ...
        <aside className="clinical-layout__side stack">
          <Card className="clinical-side-card">
            <SectionHeading
              ...
              description="Resumen corto para coordinar seguimiento y colaboración."
            />
